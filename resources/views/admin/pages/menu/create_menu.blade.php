            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        <form method="post" action="{{route("menu.store")}}" id="quickForm">
                            @csrf
                            <div class="card-body">                                
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="menu_name" class="form-control" placeholder="Nhập tên Menu">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="item_order" class="form-control" placeholder="Nhập vị trí hiển thị">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
